...
insert into groupMembers values (1, 'mike');
insert into groupMembers values (1, 'yun');
insert into groupMembers values (1, 'anjana');
...
create table questions(id varchar(100) not null primary key, question longText);
...
insert into users values('mike', password('mike'), 'mnitchie@emich.edu');
insert into users values('yun', password('yun'), 'ywang25@emich.edu');
insert into users values('anjana', password('anjana'), 'achiluka@emich.edu');
