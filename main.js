   ...
   switch (action) {
	 ...
	 cell.style.textAlign = 'center';
	    ...
	    content =
	       ...
	       Check here if this is a correct answer <input type='checkBox' name='correctResponse[]' value='"+rowCounter+"'>Yes\
	       <input type='hidden' name='correctResponseList[]' value='"+rowCounter+"'>";
         }
